      ...
      <div className="h-[46px] w-full pt-[9px] pl-[2px] flex justify-between">
        <div className="h-[46px] w-[415px] gap-[10px] flex">
          <div className="h-[44px] w-[145px] flex gap-[10px] justify-center items-center">
            <div className="h-[16px] w-[16px]">
              <Image src="/images/phone/icn settings icn-xs.svg" alt="Phone"  height={100} width={100}/>
            </div>
          ...
          <div className="h-[44px] w-[260px] gap-[10px] flex justify-center items-center">
            <div className="h-[16px] w-[16px]">
              <Image src="/images/message/icn settings icn-xs (1).svg" alt="Message" height={100} width={100}/>
            </div>
        ...
        <div className="h-[46px] w-[233px] gap-[10px] flex items-center justify-center">
          ...
          <div className="h-[26px] w-[120px] flex gap-[5px]">
            <Image className="h-[26px] w-[26px]" src="/images/insta/a.svg" alt="insta"  height={100} width={100}/>
            <Image className="h-[26px] w-[26px]" src="/images/youtube/a (1).svg" alt="yt" height={100} width={100}/>
            <Image className="h-[26px] w-[26px]" src="/images/facebook/a (2).svg" alt="fb" height={100} width={100}/>
            <Image className="h-[26px] w-[26px]" src="/images/twitter/a (3).svg" alt="twit"  height={100} width={100}/>
          </div>
        </div>
      </div>
    </div>
